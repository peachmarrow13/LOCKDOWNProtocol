...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0872FE30;
	constexpr int32 AppendString      = 0x01225F00;
	constexpr int32 GNames            = 0x0864C6C0;
	constexpr int32 GWorld            = 0x088AC6F0;
	constexpr int32 ProcessEvent      = 0x0144C5D0;
